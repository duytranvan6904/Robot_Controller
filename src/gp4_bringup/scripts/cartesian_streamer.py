...
giải IK tại 25Hz, và stream joint angles xuống MotoROS2
qua chế độ Point Queue Mode.
...
Quy trình khởi động (2 terminal):
  ...
  Terminal 2: python3 cartesian_streamer.py --demo line
...
# (robot xử lý ~23Hz, 20Hz cho margin thoải mái).
...
SMOOTH_ALPHA = 0.6       # Tăng lên để phản hồi nhanh hơn
